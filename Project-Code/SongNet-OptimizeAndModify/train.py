...
def parse_config():
    ...
    parser.add_argument('--vocab', type=str, default='./data/vocabpre.txt')
    ...
    # star
    parser.add_argument('--start_from', type=str, default='/home/data/GYX/llm/model/base/songcipre.ckpt')
    parser.add_argument('--save_dir', type=str, default='/home/data/GYX/llm/ckpt/1')
...
def run(args, local_rank):
    ...
    if args.start_from is not None:
        ...
        # # 假设 'start_from' 是包含模型权重文件路径的变量
        # checkpoint_path = args.start_from
    ...
    while True:
        ...
        for xs_tpl, xs_seg, xs_pos, ys_truth, ys_inp, ys_tpl, ys_seg, ys_pos, msk in train_data:
            ...
            if (args.world_size==1 or dist.get_rank() ==0) and batch_acm%args.print_every == -1%args.print_every:
                ...
                if (
                        args.world_size == 1 or dist.get_rank() == 0) and batch_acm % args.save_every == -1 % args.save_every:
                    ...
                    save_filename = '%s/epoch%d_batch_%d.ckpt' % (args.save_dir, train_data.epoch_id, batch_acm)
                    try:
