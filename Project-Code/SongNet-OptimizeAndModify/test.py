...
# m_path = "./model/songcipre.ckpt"
# lm_model, lm_vocab, lm_args = init_model(m_path, gpu, "./model/vocabpre.txt")
m_path = "/home/data/GYX/llm/ckpt/1/epoch24_batch_299.ckpt"
lm_model, lm_vocab, lm_args = init_model(m_path, gpu, "/home/data/GYX/llm/data/vocabpre.txt")
